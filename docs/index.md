...
4. Build a real-time translation app that can listen and speak<br/>
...
5. Build a secure microservices-based banking application<br/>
...
6. Consume and provide APIs with API Connect and Node.js<br/>
...
7. Build a framework that connects WhatsApp to Watson services<br/>
...
8. Create a web application to optimize your supply chain inventory<br/>
...
9. Online order processing during pandemics<br/>
...
10. Build an image classification model<br/>
...
11. Identify patterns, relationships, and connections using data visualization<br/>
...
12. Create an Internet of Things Platform Starter application<br/>
...
13. Turn your smartphone into an IoT device<br/>
...
14. Analyze e-commerce websites and recommend optimal pricing<br/>
...
15. Use Node.js with Cloudant DBaaS<br/>
...
16. Create an app to perform intelligent searches on data<br/>
...
17. Deploy a Watson Discovery application with New Relic observability on IBM Cloud Kubernetes Service<br/>
...
18. Connect Watson IoT and HERE Tracking<br/>
...
19. Capture clickstream data from your ecommerce website<br/>
...
20. Create a conversational voicebot using WhatsApp and Watson services<br/>
...
21. Create a next-generation call center with Watson Assistant Phone Integration<br/>
...
22. Detect data anomalies using SingleStore on IBM Cloud Pak for Data<br/>
...
23. Deploy a cloud-native application on IBM Cloud for Financial Services<br/>
...
24. Eliminate bias and enhance fairness in AI models using Cortex Certifai<br/>
...
25. Control your smart home the open source way<br/>
